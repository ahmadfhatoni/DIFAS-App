...
<div class="main-wrapper justify-content-center"> 
    <div class="bg-primary card p-4 position-relative" style="border-radius: 15px; width: 100%;">
                ...
                <tbody>
                    @forelse ($barang as $item)
                        <tr class="align-middle text-center">
                            ...
                            <td>{{ $item->stok }}</td>
                            <td>
                                <a href="{{ route('barang.edit', $item->id) }}" class="btn btn-sm btn-primary fw-semibold mb-1">Edit</a>
        ...
        <div class="mt-4 text-center">
            <a href="{{ route('barang.tambah') }}" class="btn btn-sidebar fw-semibold">Tambah Barang</a>
        </div>
    </div>
</div>
